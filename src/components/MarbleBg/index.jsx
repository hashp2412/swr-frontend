    ...
    <>
      ...
      <div className="bg-marblebg w-full h-[60rem] bg-cover relative">
        <div className="w-[30rem] h-[30rem] top-[10rem] left-[20rem] relative">
          <img src="/pic5.jpg" alt="" className="w-full h-full object-cover" />
        ...
        <div className="w-[15rem] h-[15rem] top-[34rem] left-[69rem] absolute ">
          <img src="/pic1.jpg" alt="" className="w-full h-full object-cover" />
        </div>

        <div className="w-[5rem] h-[5rem] top-[10rem] left-[14rem] absolute ">
          <img src="/pic1.jpg" alt="" className="w-full h-full object-cover" />
        </div>

        <div className="w-[5rem] h-[5rem] top-[4rem] left-[20rem] absolute ">
          <img src="/pic2.jpg" alt="" className="w-full h-full object-cover" />
        </div>

        <div className="w-[5rem] h-[5rem] top-[10rem] left-[52rem] absolute ">
          <img src="/pic3.jpg" alt="" className="w-full h-full object-cover" />
        </div>

        <div className="w-[5rem] h-[5rem] top-[41rem] left-[24rem] absolute ">
          <img src="/pic4.jpg" alt="" className="w-full h-full object-cover" />
        </div>

        <div className="w-[10rem] h-[10rem] top-[25rem] left-[8rem] absolute ">
          <img src="/pic3.jpg" alt="" className="w-full h-full object-cover" />
        </div>

        <div className="w-[12rem] h-[12rem] top-[3rem] left-[59rem] absolute ">
          <img src="/pic4.jpg" alt="" className="w-full h-full object-cover" />
        </div>
      </div>
    </>
